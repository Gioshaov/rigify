      ...
      <header className="sticky top-0 z-50 bg-surface border-b border-white/10">
        <nav className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link data-testid="nav-for-businesses" href="/for-businesses" className="font-mono text-[10px] leading-[1] tracking-[0.2em] font-medium text-on-surface-variant hover:text-primary transition-colors uppercase">
              For Businesses
            </Link>
      ...
      <footer className="bg-surface-container border-t border-white/10 mt-20">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            {/* Brand */}
            <div>
              <div className="font-hanken text-[24px] leading-[1.2] font-bold text-primary tracking-tighter uppercase mb-3">
                RIGIFY
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link data-testid="footer-for-businesses" href="/for-businesses" className="font-hanken text-[14px] leading-[1.5] text-on-surface-variant hover:text-primary transition-colors">
                    How It Works
                  </Link>
                </li>
                <li>
