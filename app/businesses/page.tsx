...
export default async function BrowseBusinessesPage() {
  ...
  // Fetch active businesses with their business_categories
      ...
      <main className="px-4 md:px-margin-desktop py-12">
        <div className="max-w-container mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="font-mono text-[10px] leading-[1] tracking-[0.2em] font-medium text-on-surface-variant uppercase mt-2">
                {processedBusinesses.length} {processedBusinesses.length === 1 ? 'Result' : 'Results'}
              </p>
            </div>
          </div>
          ...
          {processedBusinesses.length === 0 ? (
            ...
            <BusinessGrid businesses={processedBusinesses} />
          )}
        </div>
      </main>
