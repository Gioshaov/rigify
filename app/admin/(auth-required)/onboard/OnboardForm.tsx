    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white/5 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">
          Images <span className="text-gray-500 font-normal normal-case">(optional)</span>
        </h2>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              ...
              type="url"
              className="w-full bg-white/10 border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-violet-500"
              placeholder="https://example.com/cover.jpg"
            />
            <p className="text-xs text-gray-500 mt-1">Recommended: 1600×900px (16:9 ratio)</p>
          </div>
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Recommended: 400×400px (square)</p>
          </div>
        </div>
      </div>
